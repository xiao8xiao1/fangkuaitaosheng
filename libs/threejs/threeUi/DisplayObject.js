...
DisplayObject.prototype.onClick = function(callback) {
	this.ui.UiAddEventListener('click', callback, this);
};
...
DisplayObject.prototype.draw = function(context, x, y, width, height) {
	// Override me
};
...
DisplayObject.prototype.setParent = function(paraParent) {
